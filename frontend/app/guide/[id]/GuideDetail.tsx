...
const details:Record<string,{why:string;steps:string[];service:string;caution:string;official:string}>={
 "transit-card":{why:"교통카드 잔액이 부족하면 승차가 어렵고 환승 할인도 받을 수 없어요.",steps:["편의점이나 지하철역에서 티머니 카드를 구입하세요.","충전할 금액과 카드를 직원에게 건네세요.","버스와 지하철 승하차 시 단말기에 카드를 찍으세요.","환승할 때도 반드시 하차 태그를 하세요."],service:"티머니 고객센터 1644-0088",caution:"일부 충전처에서는 현금만 받을 수 있어요.",official:"요금과 환승 규칙은 인천교통공사 또는 티머니 공식 안내에서 확인하세요."},
